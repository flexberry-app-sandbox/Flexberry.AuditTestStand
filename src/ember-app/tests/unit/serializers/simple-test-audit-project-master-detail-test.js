...
moduleForModel('simple-test-audit-project-master-detail', 'Unit | Serializer | simple-test-audit-project-master-detail', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:simple-test-audit-project-master-detail',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
