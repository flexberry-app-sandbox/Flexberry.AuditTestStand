...
moduleForModel('simple-test-audit-project-master-obj', 'Unit | Serializer | simple-test-audit-project-master-obj', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:simple-test-audit-project-master-obj',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
